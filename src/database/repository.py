...
async def insert_data_in_free_scetch():
    async with async_session() as session:
        ...
        sketch1 = FreeScketch(path=r'src\free_sketch\1.jpg', description='1/19\n\n🖤Овен🖤\nСделаю в размере 15-30 см.\nСтоимость варьируется от размера, от 6.000-10.000')
        sketch2 = FreeScketch(path=r'src\free_sketch\2.jpg', description='2/19\n\n🖤Скорпион🖤\nСделаю в размере 15-30 см.\nСтоимость варьируется от размера, от 6.000-10.000')
        sketch3 = FreeScketch(path=r'src\free_sketch\3.jpg', description='3/19\n\n🖤Весы🖤\nСделаю в размере 15-30 см.\nСтоимость варьируется от размера, от 6.000-10.000')
        sketch4 = FreeScketch(path=r'src\free_sketch\4.jpg', description='4/19\n\n🖤Лев🖤\nСделаю в размере 15-30 см.\nСтоимость варьируется от размера, от 6.000-10.000')
        sketch5 = FreeScketch(path=r'src\free_sketch\5.jpg', description='5/19\n\n🖤Рак🖤\nСделаю в размере 15-30 см.\nСтоимость варьируется от размера, от 6.000-10.000')
        sketch6 = FreeScketch(path=r'src\free_sketch\6.jpg', description='6/19\n\n🖤Близнецы🖤\nСделаю в размере 15-30 см.\nСтоимость варьируется от размера, от 6.000-10.000')
        sketch7 = FreeScketch(path=r'src\free_sketch\7.jpg', description='7/19\n\n🖤Телец🖤\nСделаю в размере 15-30 см.\nСтоимость варьируется от размера, от 6.000-10.000')
        sketch8 = FreeScketch(path=r'src\free_sketch\8.jpg', description='8/19\n\nСвободные цветочные эскизы. Размер 15-20 см. \nСтоимость каждой - 6.000')
        sketch9 = FreeScketch(path=r'src\free_sketch\9.jpg', description='9/19\n\n🖤Всевидящие🖤\nРазмер 15-20 см. Стоимость любого эскиза - 6.000.')
        sketch10 = FreeScketch(path=r'src\free_sketch\10.jpg', description='10/19\n\n🖤Всевидящие🖤\nРазмер 15-20 см. Стоимость любого  эскиза - 6.000.')
        sketch11 = FreeScketch(path=r'src\free_sketch\11.jpg', description='11/19\n\n🖤Слепота🖤\nРазмер 20-25 см. Стоимость - 7.000')
        sketch12 = FreeScketch(path=r'src\free_sketch\12.jpg', description='12/19\n\n🖤Крылатые🖤\nРазмер в ширину - 15-20 см \nСтоимость каждой тату по этим эскизам - 7.000')
        sketch13 = FreeScketch(path=r'src\free_sketch\13.jpg', description='13/19\n\n🖤Сет парных татуировок🖤\nМожно сделать  и одну. \nСтоимость любого эскиза - 5.000')
        sketch14 = FreeScketch(path=r'src\free_sketch\14.jpg', description='14/19\n\n🖤Суккуб и Мутационный цветок🖤\nРазмер каждого эскиза - около 20 см. \nСтоимость каждого эскиза - 7.000')
        sketch15 = FreeScketch(path=r'src\free_sketch\15.jpg', description='15/19\n\n🖤Замок смерти, Всевидящие ягоды, Морской обитатель🖤\nРазмеры: \nЗамок - 15-23 см\nЯгоды - до 15 см \nМорской обитатель - до 15 см \n\nЦена:\nЗамок - 7.000\nЯгоды и обитатель морей - по 5.000')
        sketch16 = FreeScketch(path=r'src\free_sketch\16.jpg', description='16/19\n\n🖤Сонный паралич, Намакуби🖤\nРазмер каждого эскиза - 15-23 см. \nСтоимость любого эскиза - 7.000')
        sketch17 = FreeScketch(path=r'src\free_sketch\17.jpg', description='17/19\n\n 🖤Фламинго🖤\nПроект на целую спину. Делается в 5 сеансов длительностью не более 3-х часов. Стоимость одного сеанса - 9.000.')
        sketch18 = FreeScketch(path=r'src\free_sketch\18.jpg', description='18/19\n\n🖤Scorpio🖤\nРазмер данного эскиза 15-20 см, стоимость - 6.000.\nПредполагаемые места для нанесения: предплечье, плечо, бицепс, икра, голень, бедро, торс.')
        sketch19 = FreeScketch(path=r'src\free_sketch\19.jpg', description='19/19 \n\nПрайс на эскизы:\n🖤Морская ведьма🖤 - проект на целую внешнюю часть руки. Стоимость всего проекта - 27.000.\nПроект делается за 3 сеанса, длительность каждого - не более 3-х часов. Возможна оплата по сеансам.')
